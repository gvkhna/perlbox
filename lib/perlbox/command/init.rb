module Perlbox
  class Command
    class Init < Command
      ...
      self.summary = 'Generate a Perlbox working environment for the current directory.'
      self.description = <<-DESC
        Creates a Vagrantfile and puppet manifests for the current directory if none
        currently exists.
      DESC
